...
namespace ppconsul { namespace http { namespace impl {
    ...
    std::tuple<http::Status, ResponseHeaders, std::string> NetlibHttpClient::get(const std::string& url)
    {
    ...
    std::pair<http::Status, std::string> NetlibHttpClient::put(const std::string& url, const std::string& data)
    {
        boost::network::http::client::request request(url);
    ...
    std::pair<http::Status, std::string> NetlibHttpClient::del(const std::string& url)
    {
        boost::network::http::client::request request(url);
